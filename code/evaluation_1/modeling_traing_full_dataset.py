...
sys.path.append("/home/na/PycharmProjects/log_level_estimation/TorchLRP")
    ...
    for epoch in range(1, 1 + n_epochs):
        ...
        if pp.shape[0]<3:
            if best_f1_good < f1_score(preds1, labels_test, average='binary') and pp[0][0] >0 and pp[1][1] > 0:
                ...
                best_model = model
                # torch.save(model,
                #            "/home/na/PycharmProjects/log_level_estimation/log_level_estimation/5_results/models/incremental/" + scenario + ".pth")
                # with open(
                #         "/home/na/PycharmProjects/log_level_estimation/log_level_estimation/5_results/models/incremental/" + scenario + "_label_mapper.pickle",
                #         "wb") as file:
...
# with open("/home/na/PycharmProjects/log_level_estimation/log_level_estimation/5_results/models/explanation/" + scenario + "_tokenizer.pth", "wb") as file:
#     pickle.dump(tokenizer, file)
# torch.save(model, "/home/na/PycharmProjects/log_level_estimation/log_level_estimation/5_results/models/explanation/" + scenario + ".pth")
# with open("/home/na/PycharmProjects/log_level_estimation/log_level_estimation/5_results/models/explanation/" + scenario + "_label_mapper.pickle", "wb") as file:
#     pickle.dump(label_mapper, file)
#



# with open("/home/na/PycharmProjects/log_level_estimation/log_level_estimation/5_results/models/explanation/" + scenario + "_tokenizer.pth", "rb") as file:
#     tokenizer = pickle.load(file)
# model = torch.load("/home/na/PycharmProjects/log_level_estimation/log_level_estimation/5_results/models/explanation/" + scenario + ".pth")
# with open("/home/na/PycharmProjects/log_level_estimation/log_level_estimation/5_results/models/explanation/" + scenario + "_label_mapper.pickle", "rb") as file:
...
with open("/home/na/PycharmProjects/log_level_estimation/log_level_estimation/5_results/interpretability/"+ scenario +"/" + scenario + "_tokenizer.pickle", "wb") as file:
    pickle.dump(tokenizer, file)

torch.save(reduced_module, "/home/na/PycharmProjects/log_level_estimation/log_level_estimation/5_results/interpretability/"+ scenario+ "/" + scenario + ".pth")

with open("/home/na/PycharmProjects/log_level_estimation/log_level_estimation/5_results/interpretability/" + scenario + "/" + scenario + "_label_mapper.pickle", "wb") as file:
    pickle.dump(label_mapper, file)

with open("/home/na/PycharmProjects/log_level_estimation/log_level_estimation/5_results/interpretability/" + scenario + "/" + scenario + "_training_vectors.pickle", "wb") as file:
    pickle.dump(training_data, file)

with open("/home/na/PycharmProjects/log_level_estimation/log_level_estimation/5_results/interpretability/" + scenario + "/" + scenario + "_test_vectors.pickle", "wb") as file:
    pickle.dump(test_data, file)

with open("/home/na/PycharmProjects/log_level_estimation/log_level_estimation/5_results/interpretability/" + scenario + "/" + scenario + "_train_labels.pickle", "wb") as file:
    pickle.dump(load_train_labels, file)

with open("/home/na/PycharmProjects/log_level_estimation/log_level_estimation/5_results/interpretability/" + scenario + "/" + scenario + "_test_labels.pickle", "wb") as file:
    pickle.dump(load_test_good_repos_labels, file)

with open("/home/na/PycharmProjects/log_level_estimation/log_level_estimation/5_results/interpretability/" + scenario + "/" + scenario + "_load_train.pickle", "wb") as file:
    pickle.dump(load_train, file)

with open("/home/na/PycharmProjects/log_level_estimation/log_level_estimation/5_results/interpretability/" + scenario + "/" + scenario + "_load_test.pickle", "wb") as file:
    pickle.dump(load_test_good_repos, file)

with open("/home/na/PycharmProjects/log_level_estimation/log_level_estimation/5_results/interpretability/" + scenario + "/" + scenario + "_original_test_data.pickle", "wb") as file:
    pickle.dump(original_test_data, file)

torch.save(test_dataloader_baseline.dataset.tensors[0], "/home/na/PycharmProjects/log_level_estimation/log_level_estimation/5_results/interpretability/info_error_" + "_testdata.pth")
...
fname = "/home/na/PycharmProjects/log_level_estimation/log_level_estimation/5_results/interpretability/info_error/true_info_pred_info.txt"
...
df = pd.DataFrame([ground_truth_labels, predictions_model]).T
df.columns = ["ground_truth", "prediction"]
df.to_csv("/home/na/PycharmProjects/log_level_estimation/log_level_estimation/5_results/interpretability/info_error/prediction.csv", index=False)
...
fname = "/home/na/PycharmProjects/log_level_estimation/log_level_estimation/5_results/interpretability/info_error/true_error_pred_error.txt"
write_final_res_tof_file(final_res1, fname)



torch.save(reduced_module, "/home/na/PycharmProjects/log_level_estimation/log_level_estimation/5_results/interpretability/info_error/SHAP_neural_network.pth")
torch.save(shap_train_samples, "/home/na/PycharmProjects/log_level_estimation/log_level_estimation/5_results/interpretability/info_error/SHAP_training_data.pth")
...
with open("/home/na/PycharmProjects/log_level_estimation/log_level_estimation/5_results/interpretability/info_error/embeddings.pickle", "wb") as file:
